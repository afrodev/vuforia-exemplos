...
- (id)initWithFrame:(CGRect)frame appSession:(SampleApplicationSession *) app
{
    ...
    if (self) {
        ...
        for (int i = 0; i < kNumAugmentationTextures; ++i) {
            ...
            augmentationTexture[i] = [[Texture alloc] initWithImageFile:[NSString stringWithCString:textureFilenames[0] encoding:NSASCIIStringEncoding]];
        }
